...
class YCrCbResidualBuilder:
    ...
    def _jpeg_residual(self, image_u8):
        ...
        return self._compute_ycrcb_residual(image_u8, jpeg_np)
    ...
    def _blur_residual(self, image_u8):
        ...
        return self._compute_ycrcb_residual(image_u8, blurred)
    ...
    def _vae_residual(self, image_u8):
        ...
        return self._compute_ycrcb_residual(orig_np, recon_np)
